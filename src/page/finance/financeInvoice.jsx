...
import { listfinanceinvoice, deletefinanceinvoice } from '/api/finance'
import Common from '/page/common.jsx'
const ButtonGroup = Button.Group
import FinanceInvoiceForm from '/page/finance/financeInvoiceForm.jsx'
...
class FinanceBank extends Common{
	...
	delete = _ => {
		this.handleOk(deletefinanceinvoice, 'id', '删除', 'deleteback')
	}
