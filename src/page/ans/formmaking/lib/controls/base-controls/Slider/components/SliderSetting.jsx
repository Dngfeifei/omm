...
const SliderSetting = ({ control, updateFormModel }) => {
  ...
  return (
    <div>
      ...
      <FormAttrItem label="显示输入框">
        <Switch
          checked={options.showInput}
          onChange={(checked) => updateOptions({ showInput: checked })}
        />
      </FormAttrItem>
      ...
      <FormAttrItem label="步长">
        <InputNumberPlus
          value={options.step}
          step={1}
          onChange={(value) => updateOptions({ step: value })}
        />
      </FormAttrItem>
