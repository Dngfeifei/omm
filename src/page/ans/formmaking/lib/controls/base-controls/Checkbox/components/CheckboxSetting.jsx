...
import { Input, Switch, Select, Radio, Checkbox } from 'antd';
...
const CheckboxSetting = ({ control, updateFormModel }) => {
  ...
  return (
    <div>
      ...
      <FormAttrItem label="布局方式">
        <Radio.Group defaultValue={options.inline} buttonStyle="solid">
          <Radio.Button value={false}>块级</Radio.Button>
          <Radio.Button value={true}>行内</Radio.Button>
        </Radio.Group>
      </FormAttrItem>
