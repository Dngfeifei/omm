...
export const advanceComponents = [
  ...
  },
  {
    ...
    options: {
      ...
      remote: 2,
      remoteType: 'option',
      remoteOption: 'option_1623165081766',
      remoteOptions: [],
      props: {
        value: 'value',
        label: 'label',
...
export const basicComps = basicComponents.map((item) => {
  return {
    ...item,
    name: $t.fm.components.fields[item.type],
  };
});
export const advanceComps = advanceComponents.map((item) => {
  return {
    ...item,
    name: $t.fm.components.fields[item.type],
  };
});
export const layoutComps = layoutComponents.map((item) => {
  return {
    ...item,
    name: $t.fm.components.fields[item.type],
  };
