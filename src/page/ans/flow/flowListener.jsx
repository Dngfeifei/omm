...
const { confirm } = Modal;
import { BiListenerList,DelListener } from '/api/listener'
import ListenerFrom from '/page/ans/flow/form/ListenerFrom'
import Common from '/page/common.jsx'

class ListenerList extends Common{
    ...
    state = Object.assign({}, this.state, {
        ...
        columns: [ {
            ...
            width: 40,
            dataIndex: 'valueType',
            render: t => t == '1' ? '类' : t == '2' ? '表达式' : t == '3' ? '委托表达式':''
        },,{
            title: '值',
            width: 200,
            dataIndex: 'value'
    ...
    renderBtn = _ => <Row style={{ margin: "10px 0" }}>
        <Col span={12} >
            <Button style={{ marginRight: "10px" }} onClick={_ => this.addmodal('modalconf', '新增流程监听器信息')} type="primary">新增</Button>
