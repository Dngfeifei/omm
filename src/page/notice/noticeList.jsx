...
import NoticeForm from '/page/notice/noticeForm.jsx'

class NoticeList extends Common{
	...
	delete = _ => {
		this.handleOk(deletenotice, 'id', '删除', 'deleteback')
	}
	...
	renderSearch = _ => <div>
		<div className="mgrSearchBar">
			...
			addonBefore="关键字" placeholder="标题/内容" />
			<Button 
			onClick={this.search}
	...
	<ButtonGroup>
		<Button 
		onClick={_ => this.addmodal('modalconf', '添加公告')}
		type="primary" icon="plus">添加</Button>
		<Button 
		onClick={_ => this.editmodal('modalconf', '编辑公告')}
