...
class Inbox extends Component{
	...
	async componentWillMount() {
		let path = this.props.pane.url.indexOf('?') != -1 ? this.props.pane.url.split('?')[0] : this.props.pane.url,
			pathParam = this.props.pane.url,
			type = this.props.pane.key,
			dataType=this.props.pane.params ? this.props.pane.params : {};
