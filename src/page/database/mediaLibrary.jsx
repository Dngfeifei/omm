    ...
    render = _ => {
        ...
        return <div style={{ height: '100%', padding: "0 10px" }} >
            <Tabs defaultActiveKey="1" animated={false} onTabClick={(key, event) => {
                ...
                <TabPane tab="个人文件管理" key="1" style={{ position: "relative", paddingTop: "35px" }}>
                    <p style={{ position: "absolute", left: "12px", top: "0" }}>我的币值：{monetaryValue}</p>
                    <Personal onRef={c => this.Personal = c} listUpdate={this.allListUpdate}></Personal>
                </TabPane>
                <TabPane tab="全部文件" key="2" style={{ position: "relative", paddingTop: "35px" }}>
                    <p style={{ position: "absolute", left: "12px", top: "0" }}>我的币值：{monetaryValue}</p>
